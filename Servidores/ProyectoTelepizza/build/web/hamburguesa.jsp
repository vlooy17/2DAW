<%-- 
    ...
    Created on : 13-dic-2018, 8:47:36
    Author     : alumno_2DAW
--%>
...
<table width="100%" border="0">
  <tr bordercolor="#FF0000" bgcolor="#FF0000">
    ...
    <td colspan="3" class="inicio"><a href="index.html">Inicio </a></td>
  ...
  <tr bordercolor="#FF0000" bgcolor="#FF0000">
    ...
    <tr>
          <td></td>
          <td>Elija los menus</td>
          <td></td>
          <td><img src="images/images_2016/hamburguesa.png" width="237" height="173" alt="hamburguesa"/>
